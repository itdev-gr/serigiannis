...
export function SettingsForm({
  ...
  return (
    <form action={action} className="grid max-w-2xl gap-8">
      <div className="flex flex-wrap gap-2" role="tablist" aria-label="Ενότητες ρυθμίσεων">
        {tabs.map((label, i) => (
          <button
            ...
            className={
              tab === i
                ? 'rounded-full bg-primary px-4 py-2 font-sans text-[14px] font-medium text-surface'
                : 'rounded-full border border-border px-4 py-2 font-sans text-[14px] font-medium text-body hover:border-primary'
            }
          >
            {label}
          </button>
      ...
      <div className={tab === 1 ? 'grid gap-8' : 'hidden'}>
        <fieldset className="grid gap-5">
      ...
      <div className={tab === 2 ? 'grid gap-8' : 'hidden'}>
        <fieldset className="grid gap-5">
      ...
      <div className={tab === 3 ? 'grid gap-8' : 'hidden'}>
        <fieldset className="grid gap-5">
