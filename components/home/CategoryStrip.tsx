...
const CATEGORIES = [
  { to: '/ekdromes/monoimeres', label: 'Μονοήμερες', icon: MapPin },
  { to: '/kroyazieres', label: 'Κρουαζιέρες', icon: Ship },
  { to: '/ekdromes/polyimeres', label: 'Πολυήμερες', icon: Compass },
  { to: '/ekdromes/thalassia-mpania', label: 'Θαλάσσια Μπάνια', icon: Waves },
  { to: '/ekdromes/pezopories', label: 'Πεζοπορίες', icon: Mountain },
  { to: '/enoikiaseis-poylman', label: 'Ενοικίαση Πούλμαν', icon: Bus },
];
