...
export const homeContent = {
  hero: {
    ...
    titleTop: 'Μονοήμερες εκδρομές από Αθήνα',
    titleEmph: 'Sergiani Travel Ταξιδιωτικό Πρακτορείο',
    subtitle: '',
  ...
  about: {
    ...
    trust: [
      ...
      { title: 'Προσιτές Τιμές', text: 'Εξαιρετική σχέση ποιότητας-τιμής, με πληρωμή με μετρητά, POS, IRIS ή κάρτα.' },
    ],
  },
  listing: {
  ...
  process: {
    ...
    steps: [
      ...
      { n: '02', title: 'Κλείστε θέση', text: 'Κράτηση online, τηλεφωνικά ή στο γραφείο, πληρωμή με μετρητά, POS, IRIS ή κάρτα.' },
