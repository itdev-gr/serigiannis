...
export default async function AdminSettingsPage({
  ...
  const [settings, bookingSettings, categories, sp] = await Promise.all([
    getSettings(),
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-1 text-muted">Στοιχεία επικοινωνίας, κείμενα και εικόνες της αρχικής σελίδας.</p>
      </div>
      ...
      <SettingsForm
        settings={settings}
        action={saveSettings}
        imagesSlot={<HomeImagesManager settings={settings} categories={categories} />}
      />
