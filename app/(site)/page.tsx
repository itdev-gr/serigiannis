              ...
              <div className="grid gap-6 lg:col-span-5">
                {otherFeatured.map((tour) => (
                  <div key={tour.id} data-reveal>
                    <FeatureTripCard tour={tour} size="sm" />
                  </div>
                ))}
              </div>
            </RevealOnScroll>
      ...
      <section className="bg-cta py-16 text-surface">
        <div className="container flex flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link href="/epikoinonia" className="font-sans text-[13px] font-semibold uppercase tracking-[0.14em] underline underline-offset-4 hover:text-surface/80">
              ή στείλτε μήνυμα
            </Link>
          </div>
        </div>
